...
import { GithubIcon, Linkedin02Icon, Mail01Icon, TwitterIcon } from "@hugeicons/core-free-icons";
...
export default function PersonalWebsite({ avatarWebpSrc, avatarJpegSrc }: PersonalWebsiteProps) {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4 pt-24 text-foreground transition-colors duration-300 sm:p-6 sm:pt-24 md:p-8 md:pt-24 lg:p-12 lg:pt-24">
      <div className="flex w-full max-w-2xl justify-center">
        <div className="flex flex-col items-center justify-center text-center">
          <picture className="profile-avatar mb-6 block h-32 w-32 overflow-hidden rounded-full border border-border/60 shadow-lg ring-2 ring-background/70">
            <source srcSet={avatarWebpSrc} type="image/webp" />
            <img
              src={avatarJpegSrc}
              alt="Arda Soyturk profile photo"
          ...
          <p className="mb-8 max-w-md leading-relaxed transition-colors duration-300">
            I'm a passionate computer engineering student with a strong foundation in Node.js and
            modern web technologies. I enjoy building creative solutions, exploring new frameworks,
