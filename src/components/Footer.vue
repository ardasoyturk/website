<template>
  ...
  <div class="bg-gray-200">
    <div class="container flex flex-col flex-wrap px-5 py-3 mx-auto sm:flex-row">
      <p class="self-center text-sm text-center text-gray-500 sm:text-left">© {{ new Date().getFullYear() }} Arda Soyturk —
        <span class="text-gray-600">This website's source code is on <a href="https://github.com/ardasoyturk/website" rel="noopener noreferrer" class="underline">GitHub</a>.</span> 
      </p>
  ...
  <div class="w-full h-3 hover:bg-[#182e50] bg-[#12233c]"></div>
</footer>
</template>
